...
cd ../example/yeast/output/hadoop/
        ...
        for i in 0; do   #  for e in 0.00 0.01 0.02 0.05; do
          for d in 0; do   #  for e in 0.00 0.01 0.02 0.05; do
            for x in is; do  # is, bwtsw, c 
              ...
              -D mapred.job.name="GMA_yeast_o$o-t$th-l$l-s$s-i$i-d$d-qA" \
              ...
              -D mapred.job.arg21="/bluearc/data/schatz/hlee/genome/yeast/index.$x/NC_000913.fna" \
              ...
              rm -rf gms_yeast-l$l-s$s-i$i-d$d-o$o
              hadoop fs -get /user/hlee/gma/yeast/output gms_ecoli-l$l-s$s-i$i-d$d-o$o
      
              cd gms_yeast-l$l-s$s-i$i-d$d-o$o
